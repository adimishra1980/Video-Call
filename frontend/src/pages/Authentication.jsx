...
export default function Authentication() {
  ...
  let handleAuth = async (e) => {
    ...
    try {
      ...
      let message = err?.response?.data?.message || err.message || "An error occurred while handling authentication";
      setError(message);
    }
  };
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      <Snackbar open={open} autoHideDuration={3000} message={message} onClose={() => setOpen(false)}/>
    </ThemeProvider>
  );
}
